package top.tinn.controller.UmsController;
...
import top.tinn.common.api.CommonPage;
import top.tinn.common.api.CommonResult;
import top.tinn.dto.UmsAdminLoginParam;
...
public class UmsAdminController {
    ...
    public CommonResult login(@RequestBody UmsAdminLoginParam umsAdminLoginParam, BindingResult result) {
        ...
        }else if (token.equals("LOCKED")) return CommonResult.failed("账号已被禁用!");
