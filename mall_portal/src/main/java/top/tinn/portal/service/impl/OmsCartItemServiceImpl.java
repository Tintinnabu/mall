...
import top.tinn.mapper.OmsCartItemMapper;
import top.tinn.model.OmsCartItem;
import top.tinn.model.OmsCartItemExample;
import top.tinn.model.UmsMember;
import top.tinn.portal.dao.PortalProductDao;
...
import top.tinn.portal.service.OmsPromotionService;
...
/**
 * @Description OmsCartItemServiceImpl
 * @Author Tinn
...
public class OmsCartItemServiceImpl implements OmsCartItemService {
    ...
    public int add(OmsCartItem cartItem) {
        ...
        if (existCartItem == null) {
            ...
            existCartItem.setQuantity(existCartItem.getQuantity()
    ...
    private OmsCartItem getCartItem(OmsCartItem cartItem) {
        ...
        List<OmsCartItem> cartItemList = cartItemMapper
    ...
    public List<CartPromotionItem> listPromotion(Long memberId) {
        ...
        List<CartPromotionItem> cartPromotionItemList =
                new ArrayList<>();
        if(!CollectionUtils.isEmpty(cartItemList)){
            cartPromotionItemList = promotionService
    ...
    public int updateQuantity(Long id, Long memberId, Integer quantity) {
        ...
        return cartItemMapper
                .updateByExampleSelective(cartItem, example);
    }
